...
var tags_services_exports = {};
__export(tags_services_exports, {
  deleteTagByIdService: () => deleteTagByIdService,
  getAllTagsByUserIdService: () => getAllTagsByUserIdService,
  getTagByUserIdAndTagNameService: () => getTagByUserIdAndTagNameService,
  getTagByUserIdService: () => getTagByUserIdService,
  getTagsByUserIdAndColorService: () => getTagsByUserIdAndColorService,
  postTagService: () => postTagService,
  updateTagService: () => updateTagService
});
module.exports = __toCommonJS(tags_services_exports);
